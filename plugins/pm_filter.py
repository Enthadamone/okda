...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('<b>പടം കാണാനില്ലലോ 🤔 !! റിലീസ് അയൊന്നു ഒന്നുടെ ചെക്ക് ചെയ്യൂ....</b>')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('©️ DMCA', url=f'https://telegra.ph/Filter-Bot--Content-removalDMCA-07-25')
        ]
        ...
        buttons = [[
            InlineKeyboardButton('♥️ Updates', url='https://t.me/TeamEvamaria'),
            InlineKeyboardButton('➕ Extras', callback_data='source')
        ], [
            InlineKeyboardButton('🏠 Home', callback_data='start'),
        ...
        buttons = [[
            InlineKeyboardButton('◀️ Back', callback_data='help'),
            InlineKeyboardButton('🕵️‍♂️ Admin', callback_data='admin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap =f"<b>എന്റെ മോനെ നീ ചോയ്ച്ച പടം ഞാൻ കുറെ തപ്പി.... അവസാനം കിട്ടി ട്ടാ 😇....</b>"
